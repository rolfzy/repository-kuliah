...
function getData() {
                fetch("https://641596da9a2dc94afe657153.mockapi.io/Kucing").then(
                    (res)=>res.json()
                ).then((response)=>{
                    var tmpData  = "";
                    ...
                    response.forEach((user)=>{
                        tmpData+="<tr>"
                        tmpData+="<td>"+user.NamaKucing+"</td>";
                        tmpData+="<td>"+user.Pemilik+"</td>";
                        tmpData+="<td> <img src="+user.Gambar+"height=''alt='kosong'></td>"
